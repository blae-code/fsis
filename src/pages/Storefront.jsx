...
import { Hexagon, MonitorCog } from 'lucide-react';
  ...
  return (
    <div className="os-viewport overflow-y-auto" style={{ background: 'hsl(180, 15%, 4%)' }}>
      ...
      <header className="border-b sticky top-0 z-10 backdrop-blur-md" style={{ borderColor: 'hsl(170, 25%, 18%)', background: 'hsl(180, 15%, 4%, 0.85)' }}>
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Hexagon className="w-6 h-6 text-primary animate-pulse-glow" />
            <div>
              <h1 className="font-mono text-sm font-bold text-primary xian-glow-subtle tracking-[0.15em]">FAIRSHARE INDUSTRIAL SOLUTIONS</h1>
              <p className="text-[10px] font-mono text-muted-foreground">SALVAGE • FABRICATION • LOGISTICS — "Every credit accounted for."</p>
            </div>
          </div>
          {user?.role === 'admin' && (
      ...
      <section className="max-w-6xl mx-auto px-4 pt-10 pb-6 text-center">
        ...
        <p className="text-sm text-muted-foreground mt-2 max-w-xl mx-auto font-mono">
      ...
      <footer className="border-t py-4 text-center" style={{ borderColor: 'hsl(170, 25%, 18%)' }}>
