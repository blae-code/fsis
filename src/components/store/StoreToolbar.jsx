    ...
    <div className="flex flex-col sm:flex-row sm:items-center gap-3 font-mono">
      <div className="relative flex-1">
        ...
        <input
          ...
          className="w-full h-9 pl-9 pr-3 text-xs bg-transparent border outline-none focus:brightness-125 transition-all"
          style={{
            borderColor: '#3A2F20',
            color: '#D8CFC0',
          ...
          return (
            <button
              ...
              style={{
                ...
                ...(active
                  ? { background: 'linear-gradient(180deg, #A87C42, #6E4D24)', color: '#15100A', borderColor: '#A87C42' }
