        ...
        {STEPS.map((step, index) => {
          ...
          return (
            <div key={step.id} className="flex items-center gap-2 shrink-0">
              {index > 0 && <span className="w-5 h-px" style={{ background: active ? '#8A6430' : '#2A2118' }} />}
              <span className="inline-flex items-center gap-1.5 text-[8px] tracking-[0.14em]" style={{ color: active ? '#E0A22E' : '#6B6155' }}>
