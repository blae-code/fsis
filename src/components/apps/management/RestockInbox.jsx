...
export default function RestockInbox() {
  ...
  const markNotified = useMutation({
    mutationFn: (id) => base44.entities.restock_notify.update(id, { notified: true }),
    ...
    <div className="space-y-6 font-mono">
      ...
      <div>
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="text-[9px] tracking-[0.25em]" style={{ color: AMBER }}>RESTOCK NOTIFY QUEUE</span>
          {pending.length > 0 && (
              ...
              >
                ...
                <div className="flex items-center gap-1.5 shrink-0">
                  {!r.notified && (
                    ...
                    >
                      <Check className="w-2.5 h-2.5" /> NOTIFIED
                    </button>
                  )}
