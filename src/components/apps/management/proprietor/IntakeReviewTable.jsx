...
export default function IntakeReviewTable({ rows, setRows }) {
  ...
  return (
    <div className="space-y-2">
      {rows.map((r, idx) => (
        <div key={`${r.item_name}-${idx}`} className="grid lg:grid-cols-[1.4fr_0.8fr_0.55fr_0.55fr_0.65fr_0.75fr_auto] gap-2 border p-2" style={{ borderColor: '#3A2F20', background: '#0C0A07' }}>
