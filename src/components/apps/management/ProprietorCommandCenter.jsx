...
export default function ProprietorCommandCenter() {
  ...
  return (
    <div className="relative h-full overflow-auto p-4 font-mono" style={{ background: '#080604' }}>
      ...
      <CommandSection eyebrow="DAILY WORK" title="PRIMARY OPERATIONS" defaultOpen description="Start here for the two most frequent loops: smart stock intake, then fulfill active buyer orders.">
